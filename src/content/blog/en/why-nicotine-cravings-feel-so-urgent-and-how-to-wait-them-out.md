...
You're fine, then suddenly you're not. Your chest tightens, your hands need something to do, and every thought narrows down to one thing: nicotine, now. It feels like an emergency. It isn't. Understanding why nicotine cravings feel so urgent, and how long they actually last, changes how you deal with them.

Here's the part nobody tells you when you're white-knuckling it through day two: the craving itself is short. According to HSE Ireland, a single craving typically lasts 3 to 5 minutes. Other sources, including WebMD, put it closer to 15 to 20 minutes. Either way, it's minutes, not hours. What feels endless is usually your mind replaying the craving on a loop, not the craving itself.

## Why does quitting nicotine feel so intense?

Nicotine hijacks a very specific system in your brain. When it binds to α4β2 receptors, it triggers rapid, high-frequency bursts of dopamine release, according to Frontiers in Neuroscience (2025). This isn't a gentle mood lift. It's a burst pattern your brain wasn't designed to expect from a plant alkaloid, and it comes through dopaminergic neurons that connect the ventral tegmental area to the nucleus accumbens and prefrontal cortex, the exact circuitry involved in reward and motivation.
...
The urgency is real. So is the fact that it's temporary, every single time. A craving is a wave with a shape: it builds, it crests, it drops. Your job isn't to make it disappear on command. It's to still be standing when it does.
