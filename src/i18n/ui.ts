...
export const ui = {
  ...
  ru: {
    ...
    blog: {
      ...
      articlesFew: 'статьи',
      articles: 'статей',
      emptyFiltered: 'В этой теме пока нет статей.',
      categories: {
        A: 'Никотиновые паучи',
        B: 'Вейпинг',
        C: 'Отказ от курения',
        D: 'Несколько продуктов',
        E: 'Триггеры и психика',
        F: 'Тело и деньги',
        G: 'Выживание',
        H: 'Мифы',
      },
  ...
  de: {
    ...
    blog: {
      ...
      articlesFew: 'Artikel',
      articles: 'Artikel',
      emptyFiltered: 'In dieser Kategorie gibt es noch keine Artikel.',
      categories: {
        A: 'Nikotinbeutel',
        B: 'Vaping',
        C: 'Rauchen aufgeben',
  ...
  es: {
    ...
    blog: {
      ...
      article: 'artículo',
      articlesFew: 'artículos',
      articles: 'artículos',
      emptyFiltered: 'Todavía no hay artículos en esta categoría.',
      categories: {
        A: 'Bolsitas de nicotina',
        B: 'Vapeo',
        C: 'Dejar de fumar',
        D: 'Multiproducto',
        E: 'Desencadenantes y mente',
        F: 'Cuerpo y coste',
  ...
  fr: {
    ...
    blog: {
      ...
      articlesFew: 'articles',
      articles: 'articles',
      emptyFiltered: "Pas encore d'articles dans cette catégorie.",
      categories: {
        A: 'Sachets de nicotine',
        B: 'Vapotage',
        C: 'Arrêter de fumer',
        D: 'Multi-produits',
        E: 'Déclencheurs et esprit',
        F: 'Corps et coût',
        G: 'Guide de survie',
        H: 'Mythes',
      },
